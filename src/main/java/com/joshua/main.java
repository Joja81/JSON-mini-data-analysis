...
public class main {
   public static void main(String[] args) throws IOException {
      ...
      for (String currFile : files) {
         countInFile(currFile, participantsCount, countOfWords, stopWords);
      }
   ...
   private static HashMap<String, Integer> loadStopWords() throws FileNotFoundException {
      ...
      //TODO change to detect the file in rcourses
      ...
      try {
         ...
         for (Message curr : messages) {
            if (curr.getContent() != null) {
               countMessage(curr, participantsCount, countOfWords, stopWords);
            }
         }
         reader.close();
      } catch (Exception ex) {
